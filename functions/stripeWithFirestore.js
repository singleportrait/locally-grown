...
exports.createStripeCustomer = functions.auth.user().onCreate(async (user) => {
  functions.logger.info("Creating stripe customer");
...
exports.createStripePayment = functions.firestore
  ...
  .onCreate(async (snap, context) => {
    ...
    try {
      ...
      functions.logger.info("Customer ID", customer);
...
exports.cleanupUser = functions.auth.user().onDelete(async (user) => {
  ...
  const paymentSnapshot = await dbRef
    .doc(user.uid)
    .collection('payments')
    .get();
  paymentSnapshot.forEach((snap) => snap.ref.delete());
...
// function reportGoogleCloudLoggingError(err, context = {}) {
